      ...
      <Table.Body>
        ...
        {contract.acceptedAt ? (
          <Table.Row>
            ...
            <Table.Cell
              content={t('pages.contracts.show.contract_lifecycle.contractor')}
            />
            <Table.Cell textAlign="right">
            ...
            {contract.approvedAt ? (
              ...
              <>
                <Table.Row>
                  <Table.Cell>6.</Table.Cell>
                  <Table.Cell
                    content={t('contracts:model.statuses.declined')}
                  />
                  <Table.Cell
                    content={t('pages.contracts.show.contract_lifecycle.you')}
                  />
                ...
                {contract.refundedAt ? (
                  <Table.Row>
                    ...
                    <Table.Cell
                      content={t('contracts:model.statuses.refunded')}
                    />
                    <Table.Cell
                      content={t('pages.contracts.show.contract_lifecycle.you')}
                    />
                    <Table.Cell textAlign="right">
                      {formatTimestamp(contract.refundedAt, locale)}
                    </Table.Cell>
                  </Table.Row>
                ) : (
                  <Table.Row>
                    ...
                    <Table.Cell
                      content={t(
                        'pages.contracts.show.contract_lifecycle.refund'
                      )}
                    />
                    <Table.Cell
                      content={t('pages.contracts.show.contract_lifecycle.you')}
